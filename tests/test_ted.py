...
async def test_ted_5000() -> None:
    ...
    assert reader.mtu_value(reader.mtus[0]).daily == 28611
    ...
    assert reader.mtu_value(reader.mtus[1]).daily == 1845
    ...
    assert reader.mtu_value(reader.mtus[2]).daily == 8097
    ...
    assert reader.mtu_value(reader.mtus[3]).daily == 0
...
async def test_ted_6000() -> None:
    ...
    assert reader.mtu_value(reader.mtus[0]).daily == 22846
    ...
    assert reader.mtu_value(reader.mtus[1]).daily == 28611
    ...
    assert reader.mtu_value(reader.mtus[2]).daily == -1845
